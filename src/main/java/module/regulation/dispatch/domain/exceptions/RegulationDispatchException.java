...
public class RegulationDispatchException extends DomainException {
    ...
    public RegulationDispatchException(String bundle, String key, String... args) {
        super(bundle, key, args);
    }

    public RegulationDispatchException(Status status, String bundle, String key, String... args) {
        super(status, bundle, key, args);
    }

    public RegulationDispatchException(Throwable cause, String bundle, String key, String... args) {
